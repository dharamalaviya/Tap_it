...
class ViewController: UIViewController {
    ...
    private let view1 : UIView = {
        ...
        view.frame = CGRect(x: 20, y: 60, width: 100, height: 100)
        return view
    }()
    private let view2 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 140, y: 60, width: 100, height: 100)
        return view
    }()
    private let view3 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 260, y: 60, width: 100, height: 100)
        return view
    }()
    private let view4 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 20, y:180, width: 100, height: 100)
        return view
    }()
    private let view5 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 140, y: 180, width: 100, height: 100)
        return view
    }()
    private let view6 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 260, y: 180, width: 100, height: 100)
        return view
    }()
    private let view7 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 20, y: 300, width: 100, height: 100)
        return view
    }()
    private let view8 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 140, y: 300, width: 100, height: 100)
        return view
    }()
    private let view9 : UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        view.layer.borderWidth = 8
        view.frame = CGRect(x: 260, y: 300, width: 100, height: 100)
        return view
    }()
    ...
    private let timerlabel : UILabel = {
        ...
        label.frame = CGRect(x: 180, y: 410, width: 80, height: 50)
        return label
    }()
    ...
    private let timertxt : UILabel = {
        ...
        label.frame = CGRect(x: 130, y: 450, width: 160, height: 50)
        return label
    }()
    ...
    private let Scorelabel : UILabel = {
        ...
        label.textColor = .black
        label.font = .boldSystemFont(ofSize: 30)
        label.frame = CGRect(x: 130, y: 510, width: 160, height: 50)
        return label
    }()
    ...
    private let Score : UILabel = {
        ...
        label.frame = CGRect(x: 160, y: 540, width: 80, height: 50)
        return label
    }()
